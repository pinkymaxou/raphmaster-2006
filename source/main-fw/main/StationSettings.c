...
static const NVSJSON_SSettingEntry m_arrsConfigEntries[STATIONSETTINGS_EENTRY_Count] =
{
    ...
    [STATIONSETTINGS_EENTRY_STATION17_PosX] = NVSJSON_INITINT32_RNG("S17.PosX", "Position X", 0, 0, 100000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION17_PosY] = NVSJSON_INITINT32_RNG("S17.PosY", "Position Y", 0, 0, 100000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION17_LoadID] = NVSJSON_INITINT32_RNG("S17.LoadID", "Ingredient ID, 0 = nothing", 0, 0, 100000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION17_TotalQty] = NVSJSON_INITINT32_RNG("S17.TotalML", "Total Qty (ml)", 0, 0, 6000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION17_UsedQty] = NVSJSON_INITINT32_RNG("S17.UsedML", "Used Qty (ml)", 0, 0, 6000, NVSJSON_EFLAGS_None),

    [STATIONSETTINGS_EENTRY_STATION18_PosX] = NVSJSON_INITINT32_RNG("S18.PosX", "Position X", 0, 0, 100000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION18_PosY] = NVSJSON_INITINT32_RNG("S18.PosY", "Position Y", 0, 0, 100000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION18_LoadID] = NVSJSON_INITINT32_RNG("S18.LoadID", "Ingredient ID, 0 = nothing", 0, 0, 100000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION18_TotalQty] = NVSJSON_INITINT32_RNG("S18.TotalML", "Total Qty (ml)", 0, 0, 6000, NVSJSON_EFLAGS_None),
    [STATIONSETTINGS_EENTRY_STATION18_UsedQty] = NVSJSON_INITINT32_RNG("S18.UsedML", "Used Qty (ml)", 0, 0, 6000, NVSJSON_EFLAGS_None)
};
