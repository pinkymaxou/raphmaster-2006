...
typedef enum
{
  ...
  EFEMBEDWWW_EFILE_CSS_CONTENT_CSS = 2,    /*!< @brief File: css/content.css (size: 4.4 KB) */
  ...
  EFEMBEDWWW_EFILE_JS_APP_JS = 6,    /*!< @brief File: js/app.js (size: 3.0 KB) */
  EFEMBEDWWW_EFILE_JS_VIEWS_CALIBPAGE_JS = 7,    /*!< @brief File: js/views/CalibPage.js (size: 5.6 KB) */
  EFEMBEDWWW_EFILE_JS_VIEWS_CUSTOMCOCKTAILPAGE_JS = 8,    /*!< @brief File: js/views/CustomCocktailPage.js (size: 3.6 KB) */
  EFEMBEDWWW_EFILE_JS_VIEWS_MAKECOCKTAILPAGE_JS = 9,    /*!< @brief File: js/views/MakeCocktailPage.js (size: 4.8 KB) */
  ...
  EFEMBEDWWW_EFILE_JS_VIEWS_STATIONSETTINGSPAGE_JS = 13,    /*!< @brief File: js/views/StationSettingsPage.js (size: 4.5 KB) */
