...
typedef enum
{
  ...
  EFEMBEDWWW_EFILE_IMG_GRASSHOPPER_JPG = 24,    /*!< @brief File: img/grasshopper.jpg (size: 3.1 KB) */
  ...
  EFEMBEDWWW_EFILE_IMG_MARGARITA_JPG = 27,    /*!< @brief File: img/margarita.jpg (size: 2.9 KB) */
  EFEMBEDWWW_EFILE_IMG_MARTINI_JPG = 28,    /*!< @brief File: img/martini.jpg (size: 3.1 KB) */
  ...
  EFEMBEDWWW_EFILE_IMG_PORNSTAR_JPG = 31,    /*!< @brief File: img/pornstar.jpg (size: 4.8 KB) */
  ...
  EFEMBEDWWW_EFILE_IMG_SEX_ON_THE_BEACH_JPG = 35,    /*!< @brief File: img/sex-on-the-beach.jpg (size: 5.7 KB) */
  EFEMBEDWWW_EFILE_IMG_SKITTLE_JPG = 36,    /*!< @brief File: img/skittle.jpg (size: 973 B) */
  EFEMBEDWWW_EFILE_IMG_TOM_COLLINS_JPG = 37,    /*!< @brief File: img/tom-collins.jpg (size: 3.0 KB) */
