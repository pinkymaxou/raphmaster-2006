...
typedef enum
{
  ...
  EFEMBEDWWW_EFILE_JS_APP_JS = 6,    /*!< @brief File: js/app.js (size: 0 B) */
  ...
  EFEMBEDWWW_EFILE_JS_VIEWS_MAKECOCKTAILPAGE_JS = 9,    /*!< @brief File: js/views/MakeCocktailPage.js (size: 8.8 KB) */
