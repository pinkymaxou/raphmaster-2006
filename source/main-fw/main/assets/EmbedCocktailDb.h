...
typedef enum
{
  EFEMBEDCOCKTAILDB_EFILE_INGREDIENTS_BIN = 0,    /*!< @brief File: ingredients.bin (size: 1.5 KB) */
  EFEMBEDCOCKTAILDB_EFILE_RECIPES_BIN = 1,    /*!< @brief File: recipes.bin (size: 1.7 KB) */
