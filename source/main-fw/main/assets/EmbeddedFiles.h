...
typedef enum
{
  ...
  EF_EFILE_CSS_CONTENT_CSS = 1,    /*!< @brief File: css/content.css (size: 2.9 KB) */
  ...
  EF_EFILE_JS_VIEWS_SLOTSETTINGSPAGE_JS = 13,    /*!< @brief File: js/views/SlotSettingsPage.js (size: 4.4 KB) */
  EF_EFILE_JS_VIEWS_STATUSPAGE_JS = 14,    /*!< @brief File: js/views/StatusPage.js (size: 994 B) */
