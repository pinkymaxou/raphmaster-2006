...
typedef enum
{
  ...
  EF_EFILE_CSS_CONTENT_CSS = 1,    /*!< @brief File: css/content.css (size: 3.1 KB) */
  ...
  EF_EFILE_JS_VIEWS_INDEXPAGE_JS = 9,    /*!< @brief File: js/views/IndexPage.js (size: 5.3 KB) */
  ...
  EF_EFILE_FONT_ORBITRON_BOLD_TTF = 16,    /*!< @brief File: font/Orbitron-Bold.ttf (size: 23.7 KB) */
  EF_EFILE_FONT_ORBITRON_REGULAR_TTF = 17,    /*!< @brief File: font/Orbitron-Regular.ttf (size: 23.8 KB) */
  EF_EFILE_IMG_PORNSTAR_JPG = 18,    /*!< @brief File: img/pornstar.jpg (size: 4.8 KB) */
  EF_EFILE_FONT_ROBOTOMONO_BOLD_TTF = 19,    /*!< @brief File: font/RobotoMono-Bold.ttf (size: 85.0 KB) */
  EF_EFILE_FONT_ROBOTOMONO_REGULAR_TTF = 20,    /*!< @brief File: font/RobotoMono-Regular.ttf (size: 84.9 KB) */
  EF_EFILE_IMG_SEX_ON_THE_BEACH_JPG = 21,    /*!< @brief File: img/sex-on-the-beach.jpg (size: 5.7 KB) */
  EF_EFILE_COUNT = 22
} EF_EFILE;
