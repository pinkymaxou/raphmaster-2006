...
#define cocktaildb_RecipeStep_init_default       {0, false, cocktaildb_Qty_init_default, 0}
...
#define cocktaildb_RecipeStep_init_zero          {0, false, cocktaildb_Qty_init_zero, 0}
